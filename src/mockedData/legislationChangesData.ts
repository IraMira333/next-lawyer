...
export const legislationChangesData: LegislationChangesType[] = [
  ...
  },
  {
    ...
    uk: {
      legislationTitle:
        "Розгляд заяв громадян Російської Федерації про оформлення дозволу на імміграцію, оформлення посвідок на постійне проживання, оформлення (у тому числі замість втрачених або викрадених) та обмін посвідок на тимчасове проживання зупинено.",
    },
    en: {
      legislationTitle:
        "The processing of applications from citizens of the Russian Federation for immigration permits, issuance of permanent residence permits, issuance (including replacement of lost or stolen ones), and exchange of temporary residence permits has been suspended.",
    },
    ru: {
      legislationTitle:
